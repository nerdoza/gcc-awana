...
export default class extends Vue {
  ...
  clubStatus (update: ClubUpdate) {
    ...
    clubs.push({
      color: generalActive ? 'green darken-3' : 'grey lighten-2',
    ...
    clubs.push({
      color: cubbiesActive ? 'light-green lighten-3' : 'grey lighten-2',
    ...
    clubs.push({
      color: sparksActive ? 'amber lighten-3' : 'grey lighten-2',
    ...
    clubs.push({
      color: tntActive ? 'blue lighten-3' : 'grey lighten-2',
