...
import { faBookUser, faCalendarAlt, faChalkboardTeacher, faCloudUploadAlt, faEdit, faFileDownload, faHomeHeart, faKey, faMobileAlt, faPhone, faSignOutAlt, faSpinnerThird, faStars, faSync, faTrash, faUserPlus, faUsers, faUsersClass, faUsersCog, faUserSlash, faVideo, faWhistle } from '@fortawesome/pro-duotone-svg-icons'
