...
import { faKey, faMobileAlt, faSignOutAlt, faTrash } from '@fortawesome/pro-duotone-svg-icons'
...
library.add(faSignOutAlt, faKey, faMobileAlt, faTrash, faCaretDown, faCheck, faQuestion, faChevronLeft, faChevronRight, faSquare, faCheckSquare, faCircle, faDotCircle)
